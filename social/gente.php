...
<div id="cuerpo" class="">
	...
	<form method="POST" action="tablon.php" name="comentar">
		<textarea name="estado" cols="60" rows="2"><?php echo $usuario['estado']; ?></textarea>
		<button type="submit" form="comentar" value="Submit">Comentar</button>
	</form>
</div>
